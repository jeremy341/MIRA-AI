...
c = c.replace(
    "    def _process_results(self, results):", "    def _process_results(self, results, conf_threshold: float = 0.5):"
)
c = c.replace("            if conf < self.model_config.conf_threshold:", "            if conf < conf_threshold:")
...
with open(
    r"C:\Users\jerem\Documents\JUGEND~1\MIRA-AI\src\dashboard\backend\camera_service.py", "w", encoding="utf-8"
) as f:
    f.write(c)
...
with open(
    r"C:\Users\jerem\Documents\JUGEND~1\MIRA-AI\src\dashboard\backend\websocket_handler.py", encoding="utf-8"
) as f:
    w = f.read()
...
with open(
    r"C:\Users\jerem\Documents\JUGEND~1\MIRA-AI\src\dashboard\backend\websocket_handler.py", "w", encoding="utf-8"
) as f:
    f.write(w)
