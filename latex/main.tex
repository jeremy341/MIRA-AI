\documentclass[10pt,a4paper,bibliography=totoc,abstract=true]{scrartcl}
...
\geometry{left=2.5cm,right=2.5cm,top=2.5cm,bottom=2.5cm} % Exakte Ränder [2]
...
% 2. Das eine Inhaltsverzeichnis (auf einer eigenen Seite!)
\clearpage
\tableofcontents
\clearpage

% 3. Projektüberblick + Zusammenfassung (zählen laut Regeln nicht mit, teilen sich eine Seite)
\input{sections/projektueberblick}
\vspace{1em}
\input{sections/abstract}
\clearpage             % Beendet die römische Nummerierung und erzeugt einen sauberen Umbruch
